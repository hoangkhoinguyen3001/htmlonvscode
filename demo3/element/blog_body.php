<div id="body">
		...
		<ul class="blog">
			<li>
				<img src="../asset/images/group-yoga.jpg" alt="yoga in group">
			...
			<li>
				<img src="../asset/images/yoga-concentrating.jpg" alt="yoga concentrating">
			...
			<li>
				<img src="../asset/images/lying-yoga.jpg" alt="yoga lying down legs in the air">
